...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-40 border-b" style={{ backgroundColor: "rgba(248, 250, 252, 0.8)", borderColor: "#cbd5e1" }}>
      ...
      <div className="container py-12 max-w-3xl">
        {/* Seção: O que é */}
        <section className="mb-12 p-8 rounded-2xl border shadow-lg hover:shadow-xl transition-shadow" style={{ backgroundColor: "#f0f9ff", borderColor: "#bfdbfe" }}>
        ...
        {/* Seção: Como Funciona */}
        <section className="mb-12 p-8 rounded-2xl border shadow-lg hover:shadow-xl transition-shadow" style={{ backgroundColor: "#fffbeb", borderColor: "#fcd34d" }}>
        ...
        {/* Seção: Categorias */}
        <section className="mb-12 p-8 rounded-2xl border shadow-lg hover:shadow-xl transition-shadow" style={{ backgroundColor: "#f8fafc", borderColor: "#cbd5e1" }}>
        ...
        {/* Seção: Créditos */}
        <section className="mb-12 p-8 rounded-2xl shadow-lg" style={{ backgroundColor: "#f0f9ff", borderColor: "#bfdbfe", border: "1px solid #bfdbfe" }}>
